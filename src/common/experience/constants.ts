...
export const EXPERIENCE_BLOG: TExperienceBlog =[
  {
    ...
    detail: {
      heading: [
        "TOP 7 BÃI BIỂN Ở QUAN LẠN - ",
        "Bãi biển Quan Lạn"
      ],
      body: [
        {
          title: "Bãi Biển Quan Lạn – Thiên Đường Hoang Sơ Giữa Lòng Quảng Ninh",
          content: [
            {
        ...
        },
        {
          ...
          content: [
            {
              text: "Du khách đến đây không chỉ được thả mình trong làn nước biển mát lành mà còn có thể tham gia nhiều hoạt động thú vị như:\n\n" +
        ...
        },
        {
          ...
          content: [
            {
              text: "Để đến Quan Lạn, bạn cần di chuyển bằng tàu cao tốc từ cảng Cái Rồng hoặc cảng Hòn Gai. Thời gian di chuyển khoảng 45 phút đến 1 giờ. Cảm giác ngồi trên tàu, vượt qua những ngọn sóng và tận hưởng gió biển mát rượi sẽ là một trải nghiệm thú vị trên hành trình khám phá.\n\n" +
