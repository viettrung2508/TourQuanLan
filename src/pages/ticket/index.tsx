    ...
    <div className="w-full">
      ...
      <div className="bg-white pt-5 pb-10 -mt-32 rounded-[40px] flex justify-center z-10 relative">
        <div className="max-w-screen-2xl px-8 w-full">
          <p className="mt-10 font-bold text-primary_green-bold text-4xl">Đại lý vé</p>
          <p className="mt-6">Địa điểm tham quan, vui chơi phải trải nghiệm khi đến Phú Quốc</p>
          <div className="flex gap-6 mt-8">
            ...
            <div className="flex-1 flex flex-col">
              <div className="flex justify-end gap-6">
                  <RCheckbox checked={false} label="Hiển thị tất cả các lựa chọn" />
                  <RCheckbox checked={false} label="Chỉ các tour đang khuyến mãi" />
              </div>
              <div className="grid grid-cols-3 gap-5 mt-4">
                {Array(6).fill(0).map((item, index) => (
                  <div key={index} className="rounded-t-md w-full aspect-[9/17] flex flex-col">
                    <img src="/test.jpg" className="w-full aspect-square rounded-md"/>
                    <div className="py-4 flex-1 flex flex-col justify-between">
                      <div>
                        <p className="text-primary_green text-lg font-bold line-clamp-2">Vé Tour giao lộ thế giới Grand Word Phú Quốc</p>
                        <div className="flex justify-between gap-4 mt-3">
                          <p className="text-primary_green text-lg font-bold">Liên hệ</p>
                      ...
                      <div>
                        <div className="flex gap-1">
                          ...
                          <p >Địa điểm hẹn hò lãng mạn với tiệc trà chiều tình yêu</p>
                        </div>
                        <div className="flex gap-1">
                          <TiTick className="text-primary_green text-2xl"/>
                          <p >Địa điểm hẹn hò lãng mạn với tiệc trà chiều tình yêu</p>
              ...
              <Pagination total={6} page={page} onSetPage={setPage} className="self-center mt-8"/>
            </div>
          </div>
        </div>
      </div>
