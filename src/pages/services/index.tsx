  ...
  return (
    <div className="w-full">
      <div className="bg-[url('/bg.jpg')] h-[700px] w-full object-cover bg-cover flex items-center justify-center flex-col gap-10">
        ...
        <p className="text-4xl text-white font-semibold uppercase">
          dịch vụ lưu trú
        </p>
      </div>
      <h1 className="">dịch vụ lưu trú</h1>
      ...
      <ul className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-3 items-start gap-8">
